""" Problem 1 - Bonus Scoring System
    judge system at https://judge.softuni.org/Contests/Practice/Index/2028#1
...
for _ in range(students):
    ...
    attendances.append(current_student_attendances)

max_attendances = max(attendances)
max_bonus = max_attendances / lectures * (5 + bonus)

...
representing targets and their value. Afterward, you will be receiving indices until
...
#     if index_of_target in range(len(sequence_of_targets)):
#         target_value = sequence_of_targets[index_of_target]
#         sequence_of_targets[index_of_target] = -1
#         for index in range(len(sequence_of_targets):
#             if el in sequence_of_targets:
#                 sequence_of_targets[target] -= target_value
#     else:
#         continue
#
#
